    ...
    <div class="card-body login-card-body">
      ...
      <?php 
        ...
        if( isset($_GET['pesan']) ){
           switch ($_GET['pesan']) {
             case 'belum_login':
               $alert ='<div class="alert alert-warning">Maaf Anda Belum Login !</div>';
               break;
             case 'gagal':
              $alert ='<div class="alert alert-danger">Maaf Email/Password/Level Salah!</div>';
               break;
           }
        }
